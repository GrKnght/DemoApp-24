package ru.itis.demoapp24.core.network.di
...
import ru.itis.demoapp24.core.network.interceptor.AuthorizationInterceptor
...
class NetworkModule {
    ...
    fun provideGeniusApi(
        ...
        val builder = Retrofit.Builder()
            .baseUrl(networkConfig.GENIUS_BASE_URL)
            .client(okHttpClient)
            .addConverterFactory(gsonFactory)

        return builder.build().create(GeniusApi::class.java)
    }
